package com.android.remote.DropEditText;

/**
 * Created by wuxianke on 2018/3/31.
 */

import com.android.remote.R;
import com.android.remote.R.drawable;
import com.android.remote.R.id;
import com.android.remote.R.layout;
import com.android.remote.R.styleable;
...
public class DropEditText extends FrameLayout implements View.OnClickListener, OnItemClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mEditText = findViewById(id.dropView_edit);
        mDropImage = findViewById(id.dropView_image);
    ...
    public void setAdapter(BaseAdapter adapter) {
        ...
        mPopup.setBackgroundDrawable(new ColorDrawable(getResources().getColor(color.white)));
